{
  ...
  "examples": [
    {
      "title": "Parse proto",
      "source": "parse_proto!(decode_base64!(\"Cgdzb21lb25lIggKBjEyMzQ1Ng==\"), \"/home/runner/work/vrl/vrl/lib/docs/../../tests/data/protobuf/test_protobuf/v1/test_protobuf.desc\", \"test_protobuf.v1.Person\")",
      "return": {
        "name": "someone",
        "phones": [
          {
