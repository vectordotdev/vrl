...
impl From<ClosureInitialKind> for VariableKind {
    fn from(initial_kind: ClosureInitialKind) -> Self {
        match initial_kind {
            ClosureInitialKind::Exact(kind) => VariableKind::Exact(kind),
            ClosureInitialKind::Parameter(parameter) => VariableKind::Parameter(parameter),
            ClosureInitialKind::Target => VariableKind::Target,
            ClosureInitialKind::TargetInnerValue => VariableKind::TargetInnerValue,
            ClosureInitialKind::TargetInnerKey => VariableKind::TargetInnerKey,
        }
    }
}
