...
use crate::compiler::codes::{
    CompilerCode, ExprCode, FunctionCode, ParserCode, ValueCode, VariableCode, WarningCode,
};
...
static ERRORS: LazyLock<Vec<String>> = LazyLock::new(|| {
    [
        ExprCode::FallibleExpression as usize,
        ExprCode::InvalidRegex as usize,
        ExprCode::NonBooleanPredicate as usize,
        ExprCode::FallibleAssignment as usize,
        ExprCode::InfallibleAssignment as usize,
        ExprCode::UndefinedFunction as usize,
        ExprCode::WrongNumberOfArgs as usize,
        ExprCode::MissingArgument as usize,
        ExprCode::UnknownKeyword as usize,
        ExprCode::UnexpectedClosure as usize,
        ExprCode::InvalidArgumentKind as usize,
        ExprCode::MissingClosure as usize,
        ExprCode::InvalidGrokPattern as usize,
        ExprCode::NonStringAbortMessage as usize,
        ExprCode::ExpressionTypeUnavailable as usize,
        ExprCode::ClosureArityMismatch as usize,
        ExprCode::ClosureParameterTypeMismatch as usize,
        ExprCode::ReturnTypeMismatch as usize,
        ParserCode::InvalidToken as usize,
        ParserCode::ExtraToken as usize,
        ParserCode::User as usize,
        ParserCode::UnrecognizedToken as usize,
        ParserCode::UnrecognizedEof as usize,
        ParserCode::ReservedKeyword as usize,
        ParserCode::NumericLiteral as usize,
        ParserCode::StringLiteral as usize,
        ParserCode::Literal as usize,
        ParserCode::EscapeChar as usize,
        ParserCode::UnexpectedParse as usize,
        ParserCode::UnicodeEscape as usize,
        ValueCode::ExpectedType as usize,
        ValueCode::Coerce as usize,
        ValueCode::Remainder as usize,
        ValueCode::Multiply as usize,
        ValueCode::Divide as usize,
        ValueCode::DivideByZero as usize,
        ValueCode::NanFloat as usize,
        ValueCode::Add as usize,
        ValueCode::Subtract as usize,
        ValueCode::Or as usize,
        ValueCode::And as usize,
        ValueCode::GreaterThan as usize,
        ValueCode::GreaterThanOrEqual as usize,
        ValueCode::LessThan as usize,
        ValueCode::LessThanOrEqual as usize,
        ValueCode::ReadOnlyMutation as usize,
        ValueCode::OutOfRange as usize,
        FunctionCode::UnexpectedExpression as usize,
        FunctionCode::InvalidEnumVariant as usize,
        FunctionCode::ExpectedStaticExpression as usize,
        FunctionCode::InvalidArgument as usize,
        FunctionCode::ExpectedFunctionClosure as usize,
        CompilerCode::InvalidTimestamp as usize,
        CompilerCode::NanFloatLiteral as usize,
        CompilerCode::FunctionCompilation as usize,
        CompilerCode::AbortInfallible as usize,
        CompilerCode::FallibleArgument as usize,
        CompilerCode::FallibleExpr as usize,
        CompilerCode::UnnecessaryNoop as usize,
        CompilerCode::InvalidTarget as usize,
        CompilerCode::InvalidParentPathSegment as usize,
        CompilerCode::ChainedComparison as usize,
        CompilerCode::UnnecessaryCoalesce as usize,
        CompilerCode::MergeNonObjects as usize,
        CompilerCode::NonBooleanNot as usize,
        VariableCode::UndefinedVariable as usize,
        WarningCode::Deprecation as usize,
        WarningCode::UnusedCode as usize,
    ]
    .iter()
