...
static UA_EXTRACTOR: LazyLock<ua_parser::Extractor> = LazyLock::new(|| {
    // user_agent_regexes.rs is generated by build.rs
...
mod tests {
    ...
    test_function![
        ...
        parses_enriched {
            args: func_args![ value: "Mozilla/4.0 (compatible; MSIE 7.66; Windows NT 5.1; SV1)", mode: "enriched" ],
            want: Ok(value!({ browser: { family: "IE", major: "7", "minor": "66", patch: null, version: "7.66" }, device: { brand: null, category: "pc", family: null, model: null }, os: { family: "Windows", major: "XP", minor: null, patch: null, patch_minor: null, version: "NT 5.1" } })),
            tdef: Mode::Enriched.type_def(),
        }

        parses_reliable {
            args: func_args![ value: "Mozilla/4.0 (compatible; MSIE 7.66; Windows NT 5.1; SV1)", mode: "reliable" ],
            want: Ok(value!({ browser: { family: "Internet Explorer", version: "7.66" }, device: { category: "pc" }, os: { family: "Windows XP", version: "NT 5.1" } })),
            tdef: Mode::Reliable.type_def(),
        }

        unknown_user_agent_fast {
            args: func_args![ value: "w3m/0.3", mode: "fast" ],
            want: Ok(value!({ browser: { family: null, version: null }, device: { category: null }, os: { family: null, version: null } })),
            tdef: Mode::Fast.type_def(),
        }

        unknown_user_agent_enriched {
        ...
        unknown_user_agent_reliable {
            args: func_args![ value: "w3m/0.3", mode: "reliable" ],
            want: Ok(value!({ browser: { family: null, version: null }, device: { category: null }, os: { family: null, version: null } })),
            tdef: Mode::Reliable.type_def(),
        }
    ];
