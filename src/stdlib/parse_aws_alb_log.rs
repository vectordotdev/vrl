...
fn inner_kind() -> BTreeMap<Field, Kind> {
    BTreeMap::from([
        ...
        (Field::from("elb_status_code"), Kind::bytes() | Kind::null()),
        (Field::from("elb"), Kind::bytes() | Kind::null()),
        ...
        (
            Field::from("response_processing_time"),
            Kind::float() | Kind::null(),
        ),
        (Field::from("sent_bytes"), Kind::integer() | Kind::null()),
        (Field::from("ssl_cipher"), Kind::bytes() | Kind::null()),
        (Field::from("ssl_protocol"), Kind::bytes() | Kind::null()),
        (
            Field::from("target_group_arn"),
            Kind::bytes() | Kind::null(),
        ),
        ...
        (
            Field::from("target_processing_time"),
            Kind::float() | Kind::null(),
        ),
        (
        ...
        (Field::from("timestamp"), Kind::bytes() | Kind::null()),
        (Field::from("trace_id"), Kind::bytes() | Kind::null()),
