...
static PARAMETERS: LazyLock<Vec<Parameter>> = LazyLock::new(|| {
    vec![
        ...
        Parameter::optional("translate_custom_fields", kind::BOOLEAN, "Toggles translation of custom field pairs to `key:value`.")
    ...
    fn examples(&self) -> &'static [Example] {
        &[
            ...
            example! {
                ...
                "#},
                result: Ok(
                    r#"{"cefVersion":"1","deviceVendor":"Security","deviceProduct":"threatmanager","deviceVersion":"1.0","deviceEventClassId":"100","name":"worm successfully stopped","severity":"10","src":"10.0.0.1","dst":"2.1.2.2","spt":"1232"}"#,
                ),
            },
            example! {
                ...
                "#},
                result: Ok(
                    r#"{"cefVersion":"0","deviceVendor":"Dev","deviceProduct":"firewall","deviceVersion":"2.2","deviceEventClassId":"1","name":"Connection denied","severity":"5","Device IPv6 Address":"2345:0425:2CA1:0000:0000:0567:5673:23b5"}"#,
                ),
            },
            example! {
